...
def Cau02():
    ...
    def cv23():
        #mo flie
        f = open("CA18A1A_BuiHieuTho_44582_out.txt", mode="r", encoding="utf-8")
        ...
        f.close()
        print("=="*10)
        print("Hoan thanh viec nhap du lieu tu file: CA18A1A_BuiHieuTho_44582_inp.txt")
    ...
    def cv25():
        if len(data) == 0:
           print("Ban can chon nhap thong tin ve mat hang")
            ...
            f.close()
        print("Hoan thanh ghi ra file: CA18A1A_BuiHieuTho_44582_out.txt")
        print("++"*20)
